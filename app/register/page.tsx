...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (password !== confirmPassword) {
            handleRequestErrors(new Error("Passwords do not match"));
            return;
        }
    ...
    return (
        <div className="flex min-h-screen">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full mt-1 px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-blue-500"
            ...
            <div className="hidden lg:flex w-1/2 relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white flex-col justify-between p-12">
                ...
                <div className="absolute inset-0 opacity-10">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 border-8 border-white/10 rounded-full" />
                </div>
                ...
                <div className="relative z-10 max-w-lg">
                    <h2 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
                        Start your journey
                        <br />
                        with smarter parking
                    </h2>

                    <p className="text-blue-100 text-xl mb-10">
                        Join thousands of drivers already using ParkEasy.
                    </p>

                    <div className="space-y-4">
                        <div className="flex items-center gap-4 bg-white/5 backdrop-blur-sm px-5 py-4 rounded-2xl border border-white/10">
                            <Clock size={24} className="text-blue-200" />
                            <div>
                                <p className="font-semibold">Instant booking</p>
                                <p className="text-sm text-blue-100">Reserve in seconds</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 bg-white/5 backdrop-blur-sm px-5 py-4 rounded-2xl border border-white/10">
                            ...
                            <div>
                                <p className="font-semibold">All vehicle types</p>
                                <p className="text-sm text-blue-100">Cars, bikes, trucks</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative z-10 text-blue-200 text-sm border-t border-white/20 pt-8">
                    <p className="italic text-lg">"Simple, fast, and reliable"</p>
                    <p className="mt-2">— Trusted by thousands of users</p>
                </div>
            </div>
        </div>
    );
